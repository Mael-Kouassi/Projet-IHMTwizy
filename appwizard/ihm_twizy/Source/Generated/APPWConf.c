...
static GUI_CONST_STORAGE APPW_ANIM_ITEM _aID_ANIM_000_Items[] = {
  { ANIM_LINEAR,
    ...
    { { 0x00000000, 0, ATOM_CONSTANT, 0 },
      { 0x00000024, 0, ATOM_CONSTANT, 0 },
      { 0x18000806, 0, ATOM_OBJECT_GEO, ATOM_DETAIL_XSIZE }
    }
  },
  { ANIM_LINEAR,
    { 0x0000, 0x0020 },
    { { 0x00000000, 0, ATOM_CONSTANT, 0 },
      { 0x00000024, 0, ATOM_CONSTANT, 0 },
      { 0x18000806, 0, ATOM_OBJECT_GEO, ATOM_DETAIL_YSIZE }
    }
  }
};
...
*       ID_ANIM_000_Data
*/
GUI_CONST_STORAGE APPW_ANIM_DATA ID_ANIM_000_Data = { ID_ANIM_000, 1000, 0, -1, GUI_COUNTOF(_aID_ANIM_000_Items), _aID_ANIM_000_Items };
