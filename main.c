...
__NO_RETURN static void UARTThread (void *argument)
{
	Init_UART();
  ...
  while (1)
  {
		...
		Driver_USART6.Send("/nHello World!!!",15);
//		while(Driver_USART6.GetStatus().tx_busy == 1); // attente buffer TX vide
//		Driver_USART6.Receive(tab,12);
...
int main(void)
{
  ...
  Example: osThreadNew(app_main, NULL, NULL); */
	...
	UART_ThreadID = osThreadNew((void *) UARTThread, NULL, NULL);
